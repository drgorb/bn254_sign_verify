...
contract Verify {
    BNPairingPrecompileCostEstimator public estimator;
    ...
    function verify(bytes32 domain, uint256[4] memory publicKey, uint256[2] memory signature, bytes32 message) public view returns (bool) {
        bool callSuccess;
        bool checkSuccess;
    ...
    function verifyDefaultMessage() public view returns (bool) {
        bytes32 domain;
        ...
        return verify(domain, publicKey, signature, message);
    }
}
